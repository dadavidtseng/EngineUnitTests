...
int TestSet_MP2A1_EulerAngles()
{
	...
	eulerYawPitchRoll.EulerAngles_GetAsVectors_IFwd_JLeft_KUp( iForward, jLeft, kUp );
	asMatrix = eulerYawPitchRoll.EulerAngles_GetAsMatrix_IFwd_JLeft_KUp();
	...
	eulerYawPitchRollNeg.EulerAngles_GetAsVectors_IFwd_JLeft_KUp( iForward, jLeft, kUp );
	asMatrix = eulerYawPitchRollNeg.EulerAngles_GetAsMatrix_IFwd_JLeft_KUp();
